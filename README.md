...
- [⚡ PowerCo Client Churn & Price Analysis (Python + Streamlit)](#-powerco-client-churn--price-analysis-python--streamlit)
- [📁 Project Directory Structure](#-project-directory-structure-powerco-energy--gas-churn-analysis)
- [📊 Project Overview](#-project-overview)
- [🎯 Problem Statement](#-problem-statement)
- [🐍 Tools & Technologies](#-tools--technologies)
- [📦 Files Included](#-files-included)
- [🎯 Datasets](#-datasets)
  - [🧾 client_data.csv](#-client_datacsv)
  - [💰 price_data.csv](#-price_datacsv)
- [📊 Project Workflow](#-project-workflow)
- [📈 Python Analysis & Visualizations](#-python-overview--visualizations-powerco-churn-analysis)
  - [🧹 Data Cleaning & Preparation](#-data-cleaning--preparation)
  - [📊 Visualizations](#-visualizations)
  - [📈 Visualization Summary](#-visualization-summary)
- [🔧 Technical Implementation](#-technical-implementation)
- [🧠 Predictive Modeling](#-modeling-overview)
  - [🎯 Objective](#-objective)
  - [🧠 Model Used](#-model-used)
  - [📊 Classification Reports](#-classification-reports)
  - [📈 Performance Comparison](#-classification-performance-comparison-threshold-05-vs-0162)
  - [💡 Insights](#-insights)
  - [🧭 Business Recommendation](#-business-recommendation)
- [🌐 Streamlit Dashboard](#-streamlit-dashboard-powerco-churn-analysis-app)
  - [🔹 Features](#-features)
  - [🐍 Python Scripts](#-python-scripts)
  - [📸 Dashboard Preview](#-streamlit-dashboard-preview)
